...
// !!! как всегда все усложнил - сделал метод позволяющий найти любую цифру из числа любого размера
void VGTask10(int InputNumber, int NumIndex) // вводимое число,  номер цифры из числа (1 ... N). Выводит значение цифры
{
    int Count = 0;
